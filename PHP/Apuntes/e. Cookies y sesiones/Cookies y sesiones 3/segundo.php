...
<body>
    <?php
        ...
        //Si esta vacio usuario o contraseña 
        if (empty($usuario) || empty($password)) {
            //Redireccion a primero y dar error
            header('location: primero.php?error=Debe rellenar los campos');
                                    // a partir del ? se pone nomVariable = Valor variable 
                                    // para poner mas de uno se haria asi ?algo=eseaalgo&algo2=esealgo2
